...
//
//  Created by Kevin Green on 7/14/19.
//  Copyright © 2019 Kevin Green. All rights reserved.
//

import UIKit

// MARK: - UIBarButtonItem Badge Extensions
...
extension UIBarButtonItem {
    ...
    func setBadge(text: String?, withOffsetFromTopRight offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.red, andFilled filled: Bool = true, andFontSize fontSize: CGFloat = 11)
    {
        ...
        addBadge(text: text!, withOffset: offset, andColor: color, andFilled: filled, andFontSize: fontSize)
    }
    ...
    func getBadgeLayer() -> CAShapeLayer {
        guard let badgeLayer = self.badgeLayer else { return CAShapeLayer() }
        return badgeLayer
    }
